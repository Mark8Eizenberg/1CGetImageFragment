...
static const wchar_t g_kClassNames[] = L"ScanOneC";
...
//---------------------------------------------------------------------------//
bool ScanOneC::Init(void* pConnection)
{ 
    m_iConnect = (IAddInDefBase*)pConnection;
    return m_iConnect != NULL;
}
//---------------------------------------------------------------------------//
long ScanOneC::GetInfo()
{ 
...
//---------------------------------------------------------------------------//
bool ScanOneC::RegisterExtensionAs(WCHAR_T** wsExtensionName)
{ 
...
//---------------------------------------------------------------------------//
long ScanOneC::GetNProps()
{ 
    // You may delete next lines and add your own implementation code here
    return ePropLast;
}
//---------------------------------------------------------------------------//
long ScanOneC::FindProp(const WCHAR_T* wsPropName)
{ 
    long plPropNum = -1;
    wchar_t* propName = 0;
...
//---------------------------------------------------------------------------//
const WCHAR_T* ScanOneC::GetPropName(long lPropNum, long lPropAlias)
{ 
...
//---------------------------------------------------------------------------//
bool ScanOneC::GetPropVal(const long /*lPropNum*/, tVariant* /*pvarPropVal*/)
{ 
    return false;
}
//---------------------------------------------------------------------------//
bool ScanOneC::SetPropVal(const long /*lPropNum*/, tVariant* /*varPropVal*/)
{ 
    return false;
}
//---------------------------------------------------------------------------//
bool ScanOneC::IsPropReadable(const long /*lPropNum*/)
{ 
    return false;
}
//---------------------------------------------------------------------------//
bool ScanOneC::IsPropWritable(const long /*lPropNum*/)
{
    return false;
}
//---------------------------------------------------------------------------//
long ScanOneC::GetNMethods()
{ 
    return eMethLast;
}
//---------------------------------------------------------------------------//
long ScanOneC::FindMethod(const WCHAR_T* wsMethodName)
{ 
    long plMethodNum = -1;
    wchar_t* name = 0;
...
//---------------------------------------------------------------------------//
const WCHAR_T* ScanOneC::GetMethodName(const long lMethodNum, const long lMethodAlias)
{ 
...
//---------------------------------------------------------------------------//
long ScanOneC::GetNParams(const long lMethodNum)
{ 
    switch(lMethodNum)
    { 
    case eVersion:
...
//---------------------------------------------------------------------------//
bool ScanOneC::GetParamDefValue(const long lMethodNum, const long lParamNum,
...
//---------------------------------------------------------------------------//
bool ScanOneC::HasRetVal(const long lMethodNum)
{ 
    switch(lMethodNum)
    { 
    case eVersion:
...
//---------------------------------------------------------------------------//
bool ScanOneC::CallAsProc(const long lMethodNum,
...
//---------------------------------------------------------------------------//
bool ScanOneC::CallAsFunc(const long lMethodNum,
...
#endif
//---------------------------------------------------------------------------//
void ScanOneC::SetLocale(const WCHAR_T* loc)
{
#ifndef __linux__
...
// LocaleBase
//---------------------------------------------------------------------------//
bool ScanOneC::setMemManager(void* mem)
{
    m_iMemory = (IMemoryManager*)mem;
    return m_iMemory != 0;
}
//---------------------------------------------------------------------------//
void ScanOneC::addError(uint32_t wcode, const wchar_t* source,
...
//---------------------------------------------------------------------------//
void ScanOneC::addError(const wchar_t* errorText)
{
    if (m_iConnect)
...
//---------------------------------------------------------------------------//
long ScanOneC::findName(wchar_t* names[], const wchar_t* name,
...
//---------------------------------------------------------------------------//
bool ScanOneC::GetImageFragment(wchar_t* sourcePath, wchar_t* resultPath, int fragmentPos,
